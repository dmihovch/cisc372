 ...
 * Returns: None
 */
 //not sure why we would have to rewrite this or modify it, but i suppose we can call the broadcast from here?
...
int main(int argc,char** argv){
 ...
 startT = MPI_Wtime();
	...
	MPI_Reduce(&straightFlushes, &totalStraightFlushes, 1, MPI_INT, MPI_SUM, 0, MPI_COMM_WORLD);
	if(myRank == 0){
